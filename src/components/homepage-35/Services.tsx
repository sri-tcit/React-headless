...
const services: Service[] = [
  ...
  },
  {
    ...
    description: 'No more limitations Nafa Bank works wherever you are, whenever you need it.',
  },
];
        ...
        <div className="text-center space-y-3 mb-[70px]">
          <RevealAnimation delay={0.1}>
            <h2 className="md:max-w-[828px] sm:max-w-[600px] max-[375px]:max-w-[270px] mx-auto">
              Why Nafa Bank is the smarter way to manage your digital assets.
            </h2>
          </RevealAnimation>

          <RevealAnimation delay={0.2}>
            <p className="md:max-w-[606px] sm:max-w-[400px] max-w-[390px] mx-auto">
              Nafa Bank offers a smarter approach to managing your digital assets by providing intuitive tools and expert
