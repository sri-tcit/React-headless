    ...
    <RevealAnimation delay={0.7} instant>
      <div className="lp:mx-auto max-lp:mx-5 bg-background-3 dark:bg-background-7 relative mx-auto max-w-[1290px] overflow-hidden rounded-4xl p-2.5 max-[500px]:!mx-5 max-sm:mx-auto max-sm:max-w-[450px] max-sm:rounded-2xl max-sm:p-2">
        ...
        <button
          ...
          className="modal-action bg-secondary/10 absolute top-1/2 left-1/2 flex size-20 -translate-x-1/2 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full backdrop-blur-[18px] transition-transform duration-[400ms] ease-in-out hover:scale-110 focus:outline-none max-sm:size-14"
